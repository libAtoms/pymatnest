...
def main():
    paths = sorted(glob("../2-fixed/**/output.energies", recursive=True))
    paths_w = sorted(glob("../3-fixed-wall/**/output.energies", recursive=True))
    paths_2 = sorted(glob("../4-doubl-walk/**/output.energies", recursive=True))
